...
- TypeScript 5.x, Next.js 16.1.6, React 19.2.3 + D3.js 7 (visualization), TypeScript compiler API (analysis), simple-gi (006-simplify-ts-graph)
- N/A (ephemeral server-side analysis, no persistence) (006-simplify-ts-graph)
...
## Recent Changes
- 006-simplify-ts-graph: Added TypeScript 5.x, Next.js 16.1.6, React 19.2.3 + D3.js 7 (visualization), TypeScript compiler API (analysis), simple-gi
